...
interface GitHubService {
    ...
    // Retrofit unterstützt suspend-Functions, gegenüber der Funktion von oben hat sich hier nur der Typ
    // des Rückgabeobjekts geändert.
    @GET("orgs/{org}/repos?per_page=100")
    suspend fun getOrgRepos(
        @Path("org") org: String
    ): Response<List<Repo>>

    // Auch diese Funktion ist jetzt eine suspend-Funktion und gibt die Liste der User jetzt direkt zurück.
    @GET("repos/{owner}/{repo}/contributors?per_page=100")
